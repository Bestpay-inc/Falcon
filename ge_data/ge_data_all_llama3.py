...
parser.add_argument('--outdir', type=str, default='qwen2_7b_data_ch_en')
...
bigname = "Meta-Llama-3-8B-Instruct"
...
def build_dataset_rank(
    ...
    ds = load_dataset('json', data_files="shareGPT_Vicuna_unfiltered/ShareGPT_V4.3_unfiltered_cleaned_split.json")
    ds = ds['train']
