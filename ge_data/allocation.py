...
parser.add_argument('--outdir', type=str, default='qwen2.5-32b-instruct_gen_data')
...
for i in range(num_p):
    ...
    command = "python -m ge_data.ge_data_all_qwen2EAGLE --start={} --end={} --index={} --gpu_index {} --outdir {}".format(start, end, index,
